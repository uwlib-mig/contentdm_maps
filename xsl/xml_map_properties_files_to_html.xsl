    ...
    <xsl:template name="all_list">
        <div class="color_default">
            ...
            <ul>
                ...
                <li>'default' may be used in place of a genre/form-term column heading in collections with only one category of resource, or for a general-purpose collection category.</li>
            </ul>
